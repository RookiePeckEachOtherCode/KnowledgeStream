...
func (p *CourseInfoReq) InitDefault() {
}
...
type CourseInfoResp struct {
	...
	Membersinfo []*base.UserInfo   `thrift:"membersinfo,3" form:"membersinfo" json:"membersinfo" query:"membersinfo"`
}
...
func (p *CourseInfoResp) InitDefault() {
}
...
func (p *CourseInfoResp) GetMembersinfo() (v []*base.UserInfo) {
...
func (p *CourseInfoResp) ReadField3(iprot thrift.TProtocol) error {
...
func (p *CourseInfoResp) writeField3(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("membersinfo", thrift.LIST, 3); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteListBegin(thrift.STRUCT, len(p.Membersinfo)); err != nil {
		return err
	}
	for _, v := range p.Membersinfo {
...
func (p *CourseVideosInfoReq) InitDefault() {
}
...
func (p *CourseVideosInfoResp) InitDefault() {
}
...
func (p *CourseServiceCourseInfoArgs) InitDefault() {
}
...
func (p *CourseServiceCourseInfoResult) InitDefault() {
}
...
func (p *CourseServiceCourseVideosInfoArgs) InitDefault() {
}
...
func (p *CourseServiceCourseVideosInfoResult) InitDefault() {
}
...
func (p *CourseServiceCourseVideosInfoResult) ReadField0(iprot thrift.TProtocol) error {
	_field := NewCourseVideosInfoResp()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Success = _field
