...
func (p *StudentStatisticsReq) InitDefault() {
}
...
func (p *StudentStatisticsResp) InitDefault() {
}
...
func (p *StudentStatisticsResp) ReadField2(iprot thrift.TProtocol) error {
	...
	_field := make([]*base.StudentsStatistics, 0, size)
	values := make([]base.StudentsStatistics, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
		_elem.InitDefault()
...
func (p *TeacherStatisticsReq) InitDefault() {
}
...
func (p *TeacherStatisticsResp) InitDefault() {
}
...
func (p *TeacherStatisticsResp) ReadField2(iprot thrift.TProtocol) error {
	...
	_field := make([]*base.TeachersStatistics, 0, size)
	values := make([]base.TeachersStatistics, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
		_elem.InitDefault()
...
func (p *VideoStatisticsReq) InitDefault() {
}
...
func (p *VideoStatisticsResp) InitDefault() {
}
...
func (p *VideoStatisticsResp) ReadField2(iprot thrift.TProtocol) error {
	...
	_field := make([]*base.VideosStatistics, 0, size)
	values := make([]base.VideosStatistics, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
		_elem.InitDefault()
...
func (p *VideoPlaysStatisticsReq) InitDefault() {
}
...
func (p *VideoPlaysStatisticsResp) InitDefault() {
}
...
func (p *VideoPlaysStatisticsResp) ReadField2(iprot thrift.TProtocol) error {
	...
	_field := make([]*base.VideosPlaysStatistics, 0, size)
	values := make([]base.VideosPlaysStatistics, size)
	for i := 0; i < size; i++ {
		_elem := &values[i]
		_elem.InitDefault()
...
func (p *StatisticsServiceStudentStatisticsArgs) InitDefault() {
}
...
func (p *StatisticsServiceStudentStatisticsArgs) ReadField1(iprot thrift.TProtocol) error {
	_field := NewStudentStatisticsReq()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Req = _field
...
func (p *StatisticsServiceStudentStatisticsResult) InitDefault() {
}
...
func (p *StatisticsServiceStudentStatisticsResult) ReadField0(iprot thrift.TProtocol) error {
	_field := NewStudentStatisticsResp()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Success = _field
...
func (p *StatisticsServiceTeacherStatisticsArgs) InitDefault() {
}
...
func (p *StatisticsServiceTeacherStatisticsArgs) ReadField1(iprot thrift.TProtocol) error {
	_field := NewTeacherStatisticsReq()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Req = _field
...
func (p *StatisticsServiceTeacherStatisticsResult) InitDefault() {
}
...
func (p *StatisticsServiceTeacherStatisticsResult) ReadField0(iprot thrift.TProtocol) error {
	_field := NewTeacherStatisticsResp()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Success = _field
...
func (p *StatisticsServiceVideoStatisticsArgs) InitDefault() {
}
...
func (p *StatisticsServiceVideoStatisticsResult) InitDefault() {
}
...
func (p *StatisticsServiceVideoPlaysStatisticsArgs) InitDefault() {
}
...
func (p *StatisticsServiceVideoPlaysStatisticsArgs) ReadField1(iprot thrift.TProtocol) error {
	_field := NewVideoPlaysStatisticsReq()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Req = _field
...
func (p *StatisticsServiceVideoPlaysStatisticsResult) InitDefault() {
}
...
func (p *StatisticsServiceVideoPlaysStatisticsResult) ReadField0(iprot thrift.TProtocol) error {
	_field := NewVideoPlaysStatisticsResp()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Success = _field
