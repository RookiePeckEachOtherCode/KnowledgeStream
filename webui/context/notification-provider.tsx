...
// 修改showNotification中的定时器逻辑
    ...
    const messageInfo = useCallback(() => {
        ...
        return (
            <div
                className="fixed top-0 right-0 z-[100] flex flex-col w-1/5 p-2 gap-4 overflow-hidden m-4 transition-all duration-300 ease-in-out">
