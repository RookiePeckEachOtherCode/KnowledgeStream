...
var CourseInfoResp_Base_DEFAULT *BaseResponse

func (p *CourseInfoResp) GetBase() (v *BaseResponse) {
	if !p.IsSetBase() {
...
var CourseVideosInfoResp_Base_DEFAULT *BaseResponse

func (p *CourseVideosInfoResp) GetBase() (v *BaseResponse) {
	if !p.IsSetBase() {
...
var CourseMembersInfoResp_Base_DEFAULT *BaseResponse

func (p *CourseMembersInfoResp) GetBase() (v *BaseResponse) {
	if !p.IsSetBase() {
