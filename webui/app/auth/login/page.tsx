    ...
    return (
        <div className="flex h-screen items-center justify-center">
            <div className="flex flex-row gap-8 w-ful items-center">
                ...
                >
                    <div
                        className="flex flex-col bg-surface-container  p-24 rounded-3xl border-2 border-surface-variant shadow-xl gap-4 w-full">
                        <SplitText
                ...
                >
                    <div
                        className="flex flex-col bg-surface-container p-8 rounded-3xl border-2 border-surface-variant shadow-xl gap-4">
                        <SplitText
                            text="加入我们"
