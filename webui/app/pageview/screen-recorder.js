...
function VideoSubmitForm({videoDuration, blobSrc, uploadBlob}) {
    ...
    // TODO: 实现本地文件上传逻辑
    const handleLocalUpload = async (file, expendName) => {
    ...
    return (
        <div className="w-2/5 p-6 bg-secondary-container flex flex-col rounded-2xl space-y-6"
              ...
              {formData.description.length}/2048
                ...
                <div className="space-y-2">
                    ...
                    <input
                        ...
                        placeholder="新章节自动创建"
                    />
                    {errors.chapter && <p className="text-error text-sm">{errors.chapter}</p>}
                </div>
