...
func (p *CourseMembersInfoReq) InitDefault() {
}
...
func (p *CourseMembersInfoResp) InitDefault() {
}
...
func (p *CourseServiceCourseMembersInfoArgs) InitDefault() {
}
...
func (p *CourseServiceCourseMembersInfoArgs) ReadField1(iprot thrift.TProtocol) error {
	_field := NewCourseMembersInfoReq()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Req = _field
...
func (p *CourseServiceCourseMembersInfoResult) InitDefault() {
}
...
func (p *CourseServiceCourseMembersInfoResult) ReadField0(iprot thrift.TProtocol) error {
	_field := NewCourseMembersInfoResp()
	if err := _field.Read(iprot); err != nil {
		return err
	}
	p.Success = _field
