...
func newVideo(db *gorm.DB, opts ...gen.DOOption) video {
	...
	_video.Source = field.NewString(tableName, "source")
	_video.Title = field.NewString(tableName, "title")
	_video.Description = field.NewString(tableName, "description")
	_video.Uploader = field.NewInt64(tableName, "uploader")
	_video.Length = field.NewString(tableName, "length")
	...
	_video.Chapter = field.NewString(tableName, "chapter")
	_video.Plays = field.NewInt32(tableName, "plays")
	_video.Major = field.NewString(tableName, "major")
...
func (v *video) updateTableName(table string) *video {
	...
	v.Source = field.NewString(table, "source")
	v.Title = field.NewString(table, "title")
	v.Description = field.NewString(table, "description")
	v.Uploader = field.NewInt64(table, "uploader")
	v.Length = field.NewString(table, "length")
	...
	v.Chapter = field.NewString(table, "chapter")
	v.Plays = field.NewInt32(table, "plays")
	v.Major = field.NewString(table, "major")
