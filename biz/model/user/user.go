...
func (p *SelectMyCoursesReq) InitDefault() {
}

func (p *SelectMyCoursesReq) GetKeyword() (v string) {
	return p.Keyword
}

func (p *SelectMyCoursesReq) GetOffset() (v int32) {
	return p.Offset
}

func (p *SelectMyCoursesReq) GetSize() (v int32) {
	return p.Size
}
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_SelectMyCoursesReq[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *SelectMyCoursesReq) ReadField1(iprot thrift.TProtocol) error {
...
func (p *SelectMyCoursesReq) ReadField2(iprot thrift.TProtocol) error {
...
func (p *SelectMyCoursesReq) ReadField3(iprot thrift.TProtocol) error {
...
func (p *SelectMyCoursesReq) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("keyword", thrift.STRING, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteString(p.Keyword); err != nil {
...
func (p *SelectMyCoursesReq) writeField2(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("offset", thrift.I32, 2); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI32(p.Offset); err != nil {
...
func (p *SelectMyCoursesReq) writeField3(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("size", thrift.I32, 3); err != nil {
		goto WriteFieldBeginError
	}
	if err := oprot.WriteI32(p.Size); err != nil {
...
func (p *SelectMyCoursesResp) InitDefault() {
}

var SelectMyCoursesResp_Base_DEFAULT *base.BaseResponse

func (p *SelectMyCoursesResp) GetBase() (v *base.BaseResponse) {
	if !p.IsSetBase() {
...
func (p *UserSerivceSelectMyCoursesArgs) InitDefault() {
}
...
func (p *UserSerivceSelectMyCoursesResult) InitDefault() {
}
